...
$__LANG = array (
	...
	'd_pr_enablelog' => 'The helpdesk will log original copies of all emails coming into the helpdesk. Enabling this setting is strongly recommended so that any email related problems can be diagnosied, if thy occur.',
	...
	'd_t_cleanmailsubjects' => '<strong>Experimental feature:</strong> If enabled, ticket IDs will be suffixed (using a + sign) to the <strong>from</strong> email address (sales+ABC-123-4567@acme.com) for emails sent by the helpdesk, rather than being included in the email subject. This feature is experimental.',
