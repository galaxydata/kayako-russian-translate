...
$__LANG = array (
	...
	'desc_displayicontype' => 'Upload or link to an icon for this widget. {$themepath} can be used to point to the helpdesk images directory, for example: <em>{$themepath}icon_typetask.gif</em>.',
