...
$__LANG = array (
	...
	// ======= BEGIN CORE =======
	'activitydeleteuserorganization' => 'Deleted user organization: %s',
	'activityinsertuserorganization' => 'Inserted user organization: %s',
	'activityupdateuserorganization' => 'Updated user organization: %s',
	...
	'activityupdateuserorg' => 'Updated organization for user: %s',
	'activityupdateusergroup' => 'Updated user group for user: %s',
	'activitymergeuserorg' => 'Merged user organization: %s with: %s',
