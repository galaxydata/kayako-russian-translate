...
$__LANG = array (
	...
	'insertcfgroupmsg' => 'The cusom field group (%s) was created successfully.<br /><strong>Title:</strong> %s<br /><strong>Type:</strong> %s<br /><strong>Display order:</strong> %s',
	'updatecfgrouptitle' => 'Custom field group (%s) updated',
	'updatecfgroupmsg' => 'The cusom field group (%s) was updated successfully.<br /><strong>Title:</strong> %s<br /><strong>Type:</strong> %s<br /><strong>Display order:</strong> %s',
